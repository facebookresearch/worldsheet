...
class _FunctionSoftsplat(torch.autograd.Function):
    ...
    def backward(self, gradOutput):
        ...
        assert intFlowDepth == 2, 'intFlowDepth != 2'
        assert intInputHeight == intFlowHeight, 'intInputHeight != intFlowHeight'
        assert intInputWidth == intFlowWidth, 'intInputWidth != intFlowWidth'
