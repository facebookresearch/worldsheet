...
python mmf_cli/run.py config=projects/neural_rendering/configs/synsin_realestate10k/${EXP_NAME}.yaml \
    ...
    model_config.mesh_renderer.render_mesh_shape_for_vis=True \
    model_config.mesh_renderer.forward_results_dir=save/visualization_synsin_realestate10k/${EXP_NAME}/${ITER}/realestate10k_val${SUFFIX} \
