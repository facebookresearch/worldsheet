...
python mmf_cli/run.py config=projects/neural_rendering/configs/replica/${EXP_NAME}.yaml \
    ...
    checkpoint.resume_file=None checkpoint.resume_file=None checkpoint.resume=True run_type=val ${ARGS}
...
python mmf_cli/run.py config=projects/neural_rendering/configs/replica/${EXP_NAME}.yaml \
    ...
    checkpoint.resume_file=None checkpoint.resume_file=None checkpoint.resume=True run_type=test ${ARGS}
