...
if __name__ == "__main__":
    ...
    SAVE_IM_DIR = '/checkpoint/ronghanghu/neural_rendering_datasets/replica/large_baseline_{}/images'.format(SPLIT)
    SAVE_DATA_DIR = '/checkpoint/ronghanghu/neural_rendering_datasets/replica/large_baseline_{}/data'.format(SPLIT)
