...
if __name__ == "__main__":
    ...
    SAVE_IM_DIR = '/checkpoint/ronghanghu/neural_rendering_datasets/replica/{}/images'.format(SPLIT)
    SAVE_DATA_DIR = '/checkpoint/ronghanghu/neural_rendering_datasets/replica/{}/data'.format(SPLIT)
